...
const API_URL_PROFILE = 'https://collabmentteam.pythonanywhere.com/api/profile/update/';

const Url = 'https://collabmentteam.pythonanywhere.com/api/user/profile/update/';
const imgUrl = 'https://collabmentteam.pythonanywhere.com/'
