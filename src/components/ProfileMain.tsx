      ...
      <div className={styles.excitingNews}>
        <div className={styles.commentRetweetLikeShare}>
          ...
          <div className={styles.applicantDashboardContact}>
            <FrameProf image={"/1712668142593-3@2x.png"} 
              vector="/vector-1218.svg"
              bgcolor="#F98E73" 
              icon1="/icon-12.svg"
              icon2="/icon-22.svg" 
              icon3="/icon-32.svg"
              ...
              />
            <FrameProf image={"/1712668833786-2@2x.png"}
              vector="/vector-1219.svg"
              bgcolor="#0058FF" 
              icon1="/icon-13.svg" 
              icon2="/teenyiconstelegramoutline.svg" 
              icon3="/icon-23.svg"
              type1="Instagram"
              type2="Telegram"
              type3="Website"
              email={userData?.instagram}
              phone={userData?.telegram}
              languages={userData?.website}
              />
